...
class Dejavu:
    ...
    def align_matches(self, matches: List[Tuple[int, int]], dedup_hashes: Dict[str, int], queried_hashes: int,id_check,name_check,is_save,
    ...
    def recognize(self, recognizer, path,id = 1,name = '1',is_save = 0) -> Dict[str, any]:
        r = recognizer(self)
        return r.recognize(path, id,name,is_save)
