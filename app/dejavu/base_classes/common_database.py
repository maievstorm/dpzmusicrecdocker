...
class CommonDatabase(BaseDatabase, metaclass=abc.ABCMeta):
    ...
    def setup(self) -> None:
        ...
        with self.cursor() as cur:
            ...
            cur.execute(self.CREATE_CHECKSONG_TABLE)
    ...
    def insert_check_song(self, list_value):

        with self.cursor() as cur:
            cur.execute(self.INSERT_CHECK_SONG, (list_value))
            ...
            for index in range(0, len(values), batch_size):
                ...
                for hsh, sid, offset in cur:
                    ...
                    for song_sampled_offset in mapper[hsh]:
                        results.append((sid, offset - song_sampled_offset,offset))
